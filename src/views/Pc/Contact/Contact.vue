	...
	<div class="contact">
		<div class="contact-left">
			<transition name="slide-fade">
				<div v-if="type === 'linkedin'" :class="['slide-img linkedin', type === 'linkedin' ? 'active' : '']">
					<!-- <img src="https://fakeimg.pl/700x700/?text=linkedin&font=lobster" alt="" /> -->
					<i class="fab fa-linkedin"></i>
				</div>
			</transition>
			<transition name="slide-fade">
				<div v-if="type === 'phone'" :class="['slide-img phone', type === 'phone' ? 'active' : '']">
					<!-- <img src="https://fakeimg.pl/700x700/?text=phone&font=lobster" alt="" /> -->
					<i class="fas fa-mobile-alt"></i>
				</div>
			</transition>
			<transition name="slide-fade">
				<div v-if="type === 'mail'" :class="['slide-img mail', type === 'mail' ? 'active' : '']">
		...
		<div class="contact-right">
			...
			<div class="contant">
				<div v-if="type === 'linkedin'" class="item linkedin">
					<span>Search my ID: Tai ChiaYing</span>
					<span>or</span>
					<a href="http://linkedin.com/in/tai-chiaying-8106b3145">Click Link</a>
				</div>
				<div v-if="type === 'phone'" class="item phone">
...
.contact {
	...
	.contact-left {
		...
		.slide-img {
			padding: 10px;
			font-size: 600px;
			background: -webkit-linear-gradient(0deg, rgba(255, 255, 255, 0.1) 0, rgba(255, 255, 255, 1) 70%);
